...
export default function Recup(props) {
 ...
 <form className="center my-2 mx-5" style={{ paddingLeft:"5%",paddingRight:"5%",width:"60%", border:"double-dark" , backgroundColor:"violet"}} >
    <div  id="rqap"> 
    <h2 style={{textAlign: 'center',}}>{props.name+" Recuruitment"}</h2> <br/>
    
    <div className="form-floating my-3">
      <input type="text" className="form-control " id="floatingInput" placeholder={props.name+" Name"}  />
...
<datalist id="datalistOptions">
  ...
  <option value="Other"/>
   ...
   <label>E-mail:</label>
   <input className="form-control my-3  "  type="tel"  placeholder="E-mail:" required/>

   <label>Address:</label>
   <input className="form-control my-3 "  type="text" placeholder="Address:" required/>
   <label> Appointment Date:</label>
   <input className="form-control my-3"  type="date" placeholder=" Date" required/>
